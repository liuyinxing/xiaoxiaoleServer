...
PROTOBUF_NAMESPACE_OPEN
template<> ::GrpcLibrary::HelloReply* Arena::CreateMaybeMessage<::GrpcLibrary::HelloReply>(Arena*);
template<> ::GrpcLibrary::HelloRequest* Arena::CreateMaybeMessage<::GrpcLibrary::HelloRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace GrpcLibrary {
...
class HelloRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GrpcLibrary.HelloRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GrpcLibrary.HelloRequest";
  }
  protected:
...
class HelloReply final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GrpcLibrary.HelloReply) */ {
 public:
